...
void R_RenderDlights (void)
{
    ...
    //tpx: old way
    /*
    if (l->color[0] || l->color[1] || l->color[2])
    {
        //glColor3f (l->color[0], l->color[1], l->color[2]);
        glUniform4f(gl_coloredpolygonnotextureprogram_color,l->color[0] ,l->color[1] ,l->color[2] ,1.0);
    }
    else
        //glColor3f (0.2,0.1,0.0);
        glUniform4f(gl_coloredpolygonnotextureprogram_color,1.0 ,1.0 ,1.0 ,1.0);
     */
    
    //glUniform4f(gl_coloredpolygonnotextureprogram_color,1.0 ,0.0 ,0.0 ,1.0);
    //glUniform3f(gl_coloredpolygonnotextureprogram_color,1.0 ,0.0 ,0.0);
	glDisable (GL_BLEND);
